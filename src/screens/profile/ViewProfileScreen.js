...
export default function ViewProfileScreen({navigation}){
    ...
    React.useLayoutEffect(()=>{
        navigation.setOptions({
            headerRight:()=>(
                <TouchableOpacity style={{marginRight:20}} onPress={()=>navigation.navigate('EditProfileScreen')}>
    ...
    if (profile!=null){
      return(
        <ScrollView>
         ...
         <TouchableOpacity style={styles.forgotPassword} onPress={()=>navigation.navigate('UpdatePasswordScreen')}>
